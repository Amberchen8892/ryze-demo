          ...
          <div className="row">
            <div className="col-md-12 col-lg-6">
              <div>
                ...
                <p className="resources-hero-section-p">
                  {" "}
                  With a subscription to RYZE, you can trust that you're
                  protected against cyber threats. Enjoy the peace of mind that
                  comes with our team of cybersecurity experts protecting you
                  with on-demand 24/7 support and $1M in identity theft
            ...
            >
              <div className="resources-hero-img">
                <img src={resourcesHero} alt="resources herosection" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="methodology resources-methodology">
          <div className="methodology-container">
            ...
            <div className="methodology-list-container">
              <ul>
                <li>
                  Detect threat indicators to prevent identity theft and account
                  takeover
                </li>
                <li>
                  Alert individuals and financial institutions in real-time{" "}
                </li>
                <li>
                  The individual kill-chain is the prologue of the enterprise
                  kill-chain
                </li>
              </ul>
            </div>
              ...
              <div className="col-md-12 col-lg-6 resources-main-img-container">
                <div>
                  ...
                  <p className="resources-main-p">
                    {" "}
                    Your subscription comes with a $1 million insurance policy
                    that covers expenses such as lost wages, legal fees,
                    transportation, and other costs resulting from fraud,
                    forgery, data breaches, and identity theft incidents.
                  </p>
                </div>
              </div>
              <div className="col-md-12 col-lg-6 resources-main-img-container">
              ...
              <div className="col-md-12 col-lg-6 resources-main-img-container">
                <div>
                  ...
                  <p className="resources-main-p">
                    ...
                    with any financial or identity theft concerns. They will
                    guide you through the entire process from the initial alert
                    to the final resolution, providing personalized assistance
            ...
            <div className="row resources-main-row">
              <div className="col-md-12 col-lg-6 resources-main-img-container">
                <div>
                  ...
                  <p className="resources-main-p">
                    If you come across any links or files that seem suspicious,
                    feel free to share them with us. Our team will evaluate the
                    potential threat and provide guidance on how to address the
                    issue.
                  </p>
                </div>
              </div>
        ...
        <div className="resources-main-mobile">
          <div className="row ">
            ...
            <div className="col-12">
              ...
              <p className="resources-main-p">
                Your subscription comes with a $1 million insurance policy that
                covers expenses such as lost wages, legal fees, transportation,
                and other costs resulting from fraud, forgery, data breaches,
          ...
          <div className="row ">
            ...
            <div className="col-12">
              ...
              <p className="resources-main-p">
                ...
                any financial or identity theft concerns. They will guide you
                through the entire process from the initial alert to the final
                resolution, providing personalized assistance every step of the
                way.
              </p>
            </div>
          </div>
          <div className="row ">
            ...
            <div className="col-12">
              <h1 className="resources-main-h1">Scam assist</h1>
              <p className="resources-main-p">
                If you come across any links or files that seem suspicious, feel
                free to share them with us. Our team will evaluate the potential
                threat and provide guidance on how to address the issue.
              </p>
            </div>
          </div>
        </div>
